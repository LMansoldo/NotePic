...
const Menu = () => {
  ...
  return (
    <div className={styles.menu}>
      ...
      {isActive && <div className={styles.menuContent}>
								<Button
									onClick={() => handleBrushSizeSelection(1)}
									size="small"
									shape="circle"
								>
									<div style={{border: '1px solid #000', width: '3px', height: '3px', borderRadius: '40px', background: "#000"}} />
								</Button>
								<Button
									...
									shape="circle"
								>
									<div style={{border: '1px solid #000', width: '10px', height: '10px', borderRadius: '40px', background: "#000"}} />
								</Button>
								<Button
									...
									shape="circle"
								>
									<div style={{border: '1px solid #000', width: '12px', height: '12px', borderRadius: '40px', background: "#000"}} />
								</Button>
				</div>}
    </div>
  );
